    ...
    <div class="row">
        <div class="col-md-6 offset-md-3">
            <div class="text-center mb-4">
                <h2 class="display-4">Сочетания с повторениями</h2>
                <img src="https://avatars.mds.yandex.net/i?id=67d1ef5ce3899d654af14278e9d8b6fe-4232421-images-thumbs&n=13" class="img-fluid" alt="Formula" style="max-width: 300px;">
            </div>
